        ...
        <div>
            <div
                style={{
                    ...
                    background:
                        "linear-gradient(180deg, rgba(247,250,252,1) 33%, rgba(241,245,249,1) 67%, rgba(239,243,247,1) 87%, rgba(239,243,247,1) 95%, rgba(237,242,247,1) 100%)",
                }}
                className="relative rounded-b-lg px-4 sm:px-6 lg:px-8 mx-auto">
